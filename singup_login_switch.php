...
<body>
    ...
    <!-- 登入提示框 -->
    <div class="showup_box_300x150" id="show_box_login">
        <p>登入成功</p>
        <button class="showup_box_button_300x150" data-target="#show_box_login">確定</button>
    </div>
    <div class="showup_box_300x150" id="show_box_login_fail">
        <p>登入失敗</p>
        <button class="showup_box_button_300x150" data-target="#show_box_login_fail">確定</button>
    </div>
    ...
    <script>
        ...
        $('.showup_box_button_300x150').click(function() {
                    console.log('id:', $(this).data('target'); $($(this).data('target')).hide();
                    });
    </script>
